...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const vault = await deploy('Vault', {
    from: deployer,
    args: [authorizer.address, testWETH.address, rwaRegistry.address, PAUSE_WINDOW_DURATION, BUFFER_PERIOD_DURATION], // if the constructor requires arguments, pass them here
...
func.dependencies = ['TestWETH', 'Authorizer', 'RwaRegistry'];
